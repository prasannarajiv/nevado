...
/**
 *
 * Due to the nevado jar being packaged in a shaded(uber) jar the classloading that happens
 * in the HandlerChainFactory class are referencing classes that are outside our shaded jar through
 * a resource file which was held on the file system.
 * The solution was to create a new AmazonSQSClient, which will allow us to use our own resource file to
 * call the classes within the shade.
 */

public class OVCAmazonSQSClient extends AmazonWebServiceClient implements AmazonSQS {
	 ...
	 * @see DefaultAWSCredentialsProviderChain
	 */
	public OVCAmazonSQSClient(ClientConfiguration clientConfiguration) {
	 ...
	 *                       (ex: proxy settings, retry counts, etc.).
	 */
	public OVCAmazonSQSClient(AWSCredentials awsCredentials, ClientConfiguration clientConfiguration) {
	 ...
	 */
	public OVCAmazonSQSClient(AWSCredentialsProvider awsCredentialsProvider) {
	 ...
	 *                       (ex: proxy settings, retry counts, etc.).
	 */
	public OVCAmazonSQSClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
